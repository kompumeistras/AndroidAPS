package app.aaps.ui.compose.overview.notifications
...
fun NotificationBottomSheet(
    ...
    ModalBottomSheet(
        ...
        LazyColumn {
            item {
                Text(
                    text = stringResource(app.aaps.core.ui.R.string.notification),
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(4.dp)) {
                if (notification.actions.isNotEmpty()) {
                    ...
                    FilledTonalButton(onClick = { onDismiss() }) {
                        Text(text = stringResource(app.aaps.core.ui.R.string.dismiss))
                    }
                }
            }
        }
